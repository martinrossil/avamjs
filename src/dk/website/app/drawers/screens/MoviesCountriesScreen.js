...
export default class MoviesCountriesScreen extends BaseScreen
{
    constructor()
    {
        super();
    ...
    get list()
    {
        if( !this._list )
        {
            ...
            this._list.uid = UIDS.MOVIES_COUNTRIES_LIST;
...
customElements.define("movies-countries-screen", MoviesCountriesScreen ); 