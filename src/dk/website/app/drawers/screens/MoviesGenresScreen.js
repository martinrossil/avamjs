...
export default class MoviesGenresScreen extends BaseScreen
{
    constructor()
    {
        super();
    ...
    get list()
    {
        if( !this._list )
        {
            ...
            this._list.uid = UIDS.MOVIES_GENRES_LIST;
...
customElements.define("movies-genres-screen", MoviesGenresScreen ); 