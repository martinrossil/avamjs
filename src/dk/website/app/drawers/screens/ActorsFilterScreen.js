...
import ActorsCountriesScreen from "./ActorsCountriesScreen.js";
...
export default class ActorsFilterScreen extends BaseScreen
{
    constructor()
    {
        super();
    ...
    get filterListDataProvider()
    {
        ...
        {
            let filters = [ { icon : IconNames.PUBLIC, l : Strings.COUNTRIES, h : Paths.ACTORS_COUNTRIES } ];    
    ...
    get screensNavigator()
    {
        if( !this._screensNavigator )
        {
            ...
            this._screensNavigator.uid = UIDS.ACTORS_FILTERS_SCREEN_NAVIGATOR;
            this._screensNavigator.layoutData = new AnchorLayoutData( 8, 104, 8, 0 );
            this._screensNavigator.addScreen( new ActorsCountriesScreen() );
        }
        return this._screensNavigator;
    }
}
customElements.define( "actors-filter-screen", ActorsFilterScreen );