...
export default class ActorsCountriesScreen extends BaseScreen
{
    constructor()
    {
        super();
    ...
    get list()
    {
        if( !this._list )
        {
            ...
            this._list.uid = UIDS.ACTORS_COUNTRIES_LIST;
...
customElements.define("actors-countries-screen", ActorsCountriesScreen );