...
export default class TrailersCountriesScreen extends BaseScreen
{
    constructor()
    {
        super();
    ...
    get list()
    {
        if( !this._list )
        {
            ...
            this._list.uid = UIDS.TRAILERS_COUNTRIES_LIST;
...
customElements.define("trailers-countries-screen", TrailersCountriesScreen ); 